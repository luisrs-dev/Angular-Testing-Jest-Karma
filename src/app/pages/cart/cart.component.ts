...
export class CartComponent implements OnInit {
  ...
  ngOnInit(): void {
    // Sirve para validar si efectivamnte se esta llamando a ngOnInit
    // En el specCurso en beforeach se llama a la línea 
    //spyOn(bookService, 'getBooksFromCart').and.callFake( () => listBooks);
    // De esa manera se evita hacr un llamado al servicio

    console.log('Sirve para validar si efectivamnt');
